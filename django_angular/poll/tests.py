...
class ChoiceModelTests(TestCase):
    def test_choice_stringify(self):
        """
        Ensure the choice stringifies properly
        there's nothing else on this model class to test..
        """
        choice = Choice(choice_text="This is a choice")
        self.assertEqual(repr(choice), "<Choice: This is a choice>")
        self.assertEqual(str(choice), "This is a choice")
